...
class GoogleAuthController extends Controller
{
    ...
    {
        // Stocker le token de l'utilisateur pour le retrouver après
    ...
    public function callback(Request $request)
    {
        try {
            ...
            // Priorité 1 : session web (popup sur le même domaine = même cookie)
            $user = Auth::user();

            // Priorité 2 : token Sanctum stocké en session (format "id|rawToken")
            if (!$user) {
