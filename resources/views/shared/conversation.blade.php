...
<body class="layout-chat" data-theme="dark">
    <div class="shared-conversation">
        ...
        <header class="shared-header">
            <a href="{{ route('home') }}" class="shared-brand">
            ...
            <a href="{{ route('register') }}" class="btn btn-primary shared-cta">
                Créer un compte
            </a>
        </header>
        ...
        <footer class="shared-footer">
            <p>Créé avec <a href="{{ route('home') }}">HR Chatbot</a> &middot; <a href="{{ route('register') }}">Rejoindre gratuitement</a></p>
        </footer>
    </div>
